...
(function () {
    ...
    var s = e.helpers = {}, n = s.each = function (t, i, e) {
        ...
        for (var d = Math.abs(u - c), p = x(d), f = Math.ceil(u / (1 * Math.pow(10, p))) * Math.pow(10, p), v = s ? 0 : Math.floor(c / (1 * Math.pow(10, p))) * Math.pow(10, p), S = f - v, C = Math.pow(10, p), y = Math.round(S / C); (y > h || h > 2 * y) && !l;) if (y > h) C *= 2, y = Math.round(S / C), y % 1 !== 0 && (l = !0); else if (o && p >= 0) {
            if (C / 2 % 1 !== 0) break;
            C /= 2, y = Math.round(S / C)
        } else C /= 2, y = Math.round(S / C);
        return l && (y = a, C = S / y), {steps: y, stepValue: C, min: v, max: v + y * C}
    ...
    e.instances = {}, e.Type = function (t, i, s) {
        ...
        inRange: function (t, i) {
            var e = s.getAngleFromPoint(this, {x: t, y: i}), n = e.angle % (2 * Math.PI),
        ...
        initialize: function () {
            ...
            for (this.ctx.font = W(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++) t = this.getPointPosition(i, d), e = this.ctx.measureText(y(this.templateString, {value: this.labels[i]})).width + 5, 0 === i || i === this.valuesCount / 2 ? (s = e / 2, t.x + s > p && (p = t.x + s, n = i), t.x - s < g && (g = t.x - s, a = i)) : i < this.valuesCount / 2 ? t.x + e > p && (p = t.x + e, n = i) : i > this.valuesCount / 2 && t.x - e < g && (g = t.x - e, a = i);
            ...
            if (this.display) {
                ...
                if (n(this.yLabels, function (i, e) {
                    ...
                    for (var i = this.valuesCount - 1; i >= 0; i--) {
                        ...
                        var c = this.labels.length, u = this.labels.length / 2, d = u / 2, p = d > i || i > c - d,
                            f = i === d || i === c - d;
        ...
        frameDuration: 17, animations: [], dropFrames: 0, addAnimation: function (t, i) {
            for (var e = 0; e < this.animations.length; ++e) if (this.animations[e].chartInstance === t) return void (this.animations[e].animationObject = i);
